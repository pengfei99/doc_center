...
## 4.1 Understanding the dns name resolution Process

When you type a [URL](https://en.wikipedia.org/wiki/URL) in your web browser, the web browser will first use the DNS protocol to contact the DNS server that has been configured in your web brower (or PC).
