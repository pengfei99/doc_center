...
## Use docker image 
hadoop does provide a docker image for building hadoop in windows. You can find the origin [DockerFile](https://github.com/apache/hadoop/blob/trunk/dev-support/docker/Dockerfile_windows_10).
