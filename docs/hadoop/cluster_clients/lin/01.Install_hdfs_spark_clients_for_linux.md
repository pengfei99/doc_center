...
## pre-requis
To ensure security and admin access of the hdfs cluster, we need to setup a `group hadoop` group. but not `user hadoop`.
```shell
...
> In the client hadoop, you don't need to add sbin in the path
## Install spark
