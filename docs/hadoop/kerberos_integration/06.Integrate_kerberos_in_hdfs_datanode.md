...
In this tutorial, we show how to secure a hadoop cluster with kerberos.
...
<configuration>
    <property>
        ...
        <description>The primary NameNode URI. Defines the default file system host and port for all HDFS operations.
        </description>
    </property>
    ...
    <property>
        ...
        <description>Maps Kerberos principals (user@REALM) to local Linux usernames. This rule strips the @CASD.FR
            suffix from Active Directory accounts.
        </description>
    </property>
</configuration>
```
