...
![docker-container-lifecycle-management.png](../../assets/docker-container-lifecycle-management.png)
...
You can find the source file in [src/composetest](../../../src/docker/build_image/composetest)
