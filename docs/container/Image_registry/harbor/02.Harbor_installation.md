...
To install docker engine and compose, you can follow this [doc](../../Docker/01.Install_docker_dockerCompose.md).
...
You can find an example in [harbor.yaml](../../../../src/harbor/docker-compose/harbor.yaml)
...
For example, below is a minimum docker file. You can find the full example in [sample_docker_file](../../../../src/harbor/sample_docker_file/)
