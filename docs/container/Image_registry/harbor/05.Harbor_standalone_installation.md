...
### 6.6 Tag and retag image

Harbor allow an image to have multiple tag. Just open an image and click on `add a tag` button to 
add a new tag. 

#### Retag (copy to another project with new tag)

Harbor allow you to retag an image.
